#http://www.4answered.com/questions/view/1897221/PyQt5-Filebrowser-Signal-Slot-connecting-QTreeView-to-QColumnview
...
class Browser(QMainWindow):
    ...
    def createDockWindows(self):
        ...
        FileView.setRootIndex(filemodel.index(rootpath)) ##########ssss
