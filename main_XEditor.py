...
from PyQt5.QtWidgets import (QAction, QApplication,  QFileDialog, QMainWindow, QMessageBox, QTextEdit, QFrame)
...
class PythonHighlighter(QSyntaxHighlighter):
    ...
    def __init__(self, parent=None):
        ...
        PythonHighlighter.Rules.append((QRegExp("|".join([r"\b%s\b" % constant for constant in CONSTANTS])), "constant"))
    ...
    def initializeFormats():
        ...
        for name, color in (
                ("normal"   , Qt.white     ), ("keyword"  , Qt.darkBlue  ), ("builtin", Qt.darkRed  ),
    ...
    def highlightBlock(self, text):
        ...
        textLength = len(text) #test is just one line
        prevState = self.previousBlockState() #0 or -1?

        self.setFormat(0, textLength, PythonHighlighter.Formats["normal"])
        #print( PythonHighlighter.Formats["normal"] )
        #print( PythonHighlighter.Formats )
        #print( PythonHighlighter )
...
class MainWindow(QMainWindow):
    ...
    def __init__(self, filename=None, parent=None):
        ...
        #a = self.editor.textCursor
        #.setFont(QFont("Microsoft YaHei"))
#        Cursor_ = QTextCursor()
#        Cursor_.setTextColor( Qt.white )
#        self.editor.setCursor(  Cursor_ )
...
#            self.editor.setAutoFillBackground( True )
        ...
        #self.editor.setB
        #self.editor.setColor    ( QColor(  0,  0,  0) )
        #self.editor.setTextColor( QColor(255,255,255) )
#         palette.setColor(QPalette.Window, Qt.black)
#            self.editor.setPalette(palette)
        #self.editor.setStyleSheet( "color:white")
        #self.editor.setStyleSheet( "background-color:black" )      
        ...
        self.editIndentAction = self.createAction("&Indent",  self.editIndent, "Ctrl+]", "editindent",  "Indent the current line or selection")
        self.editUnindentAction = self.createAction("&Unindent",  self.editUnindent, "Ctrl+[", "editunindent",  "Unindent the current line or selection")
        ...
        self.addActions(editMenu, (self.editCopyAction, self.editCutAction, self.editPasteAction, None, self.editIndentAction, self.editUnindentAction))
